...
import { getAllGuardians, getGuardianStatus, getNewGuardianSignups  } from "@/redux/Proprietor/ProprietorSlice";
...
const Parents = () => {
  ...
  let allGuardiansData = useSelector((state) => state.proprietor.getAllGuardiansData);
