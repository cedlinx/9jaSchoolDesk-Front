...
const Submitted = ({submittedTasks}) => {
  ...
  return (
    <>
      ...
      {Array.isArray(submittedTasks) && <TableComponent loading={loading} columnsHeader={columnsHeader} tableData= {getTableData(submittedTasks)} showHeader={true} emptyDataText="There are no submitted tasks" />}
    </>
  );
};
