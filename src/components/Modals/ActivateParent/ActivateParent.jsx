...
import styles from "./ActivateParent.module.scss";
...
const ActivateParent = () => {
  ...
  return (
    ...
    <section className={cx(styles.activateParentContainer, "flexCol")}>

      <div className={cx(styles.header, "flexRow-space-between")}>
        <Icon onClick={()=>dispatch(showModal({ action: "hide", type: "activateParent" }))} icon="carbon:close-filled" color="white" />
      </div>
	  ...
	  <div className={cx(styles.header, "flexCol")}>
        ...
        <div className={cx(styles.btnGroup, "flexRow")}>
          <Button onClick={() => dispatch(showModal({action: "hide", type: "activateParent"}))} type title="Cancel" borderRadiusType="fullyRounded" textColor="#D25B5D" bgColor="#fff" bordercolor="#D25B5D" />
          <Button type title="Activate" borderRadiusType="fullyRounded" textColor="#fff" bgColor="#D25B5D" bordercolor="#D25B5D" />
        </div>
...
ActivateParent.propTypes = {
  title: PropTypes.string
};

export default ActivateParent;