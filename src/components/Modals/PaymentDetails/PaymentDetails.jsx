			...
			{data ? 
				<>
					...
					<div className={cx(styles.btnGroup)}>
						<Button onClick={() => handleClick()} title="Cancel" textColor="#FFF" borderRadiusType="lowRounded" bordercolor="2C0085" bgColor="#2C0085" />
						<Button onClick={() => handleClick(dispatchAction)} title="Remove Admin" textColor="#FFF" borderRadiusType="lowRounded" bordercolor="2C0085" bgColor="#2C0085" />
					</div>
