...
const All = ({allTasks}) => {
  ...
  return (
    <>
      ...
      {Array.isArray(allTasks) && <TableComponent loading={loading} columnsHeader={columnsHeader} tableData= {getTableData(allTasks)} showHeader={true} emptyDataText="There are no tasks yet" />}
    </>
  );
};
