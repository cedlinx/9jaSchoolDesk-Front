...
import styles from "./AssignToClass.module.scss";
...
const AssignToClass = () => {
  ...
  return (
    ...
    <section className={cx(styles.assignToClassContainer, "flexCol")}>

      <div className={cx(styles.header, "flexRow-space-between")}>
        <Icon onClick={()=>dispatch(showModal({ action: "hide", type: "assignToClass" }))} icon="carbon:close-filled" color="white" />
      </div>
