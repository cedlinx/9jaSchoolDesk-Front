...
`;
	...
	return (	
		<ButtonComponent type onClick={onClick} disabled={disabled} className={cx(styles.btn, "flexRow"  )} style={{ color: `${textColor}`, backgroundColor: `${bgColor}`, borderColor: `${bordercolor}`, border: bordercolor ? "1px solid" : `1px solid ${bgColor}`}}>
			{loading ? ( <img
				src={imageLoader}
				height="18" />) : (
				<>
